...
public:
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, ros::ServiceClient& client);
...
protected:
    ...
    void Track();
    void Track_ros(ros::ServiceClient& client);
    ...
    void CreateNewKeyFrame_ros(ros::ServiceClient &client);
