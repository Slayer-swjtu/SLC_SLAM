...
for x in range(10):
    ...
    rgb_frames.append(frameset.get_color_frame())
...
for x in range(len(rgb_frames)):
    ...
    cv2.waitKey(3)
    cv2.imwrite("sample"+str(x)+"_rgb"+'.png', color_image)
    cv2.imwrite("sample"+str(x)+"_depth"+'.png', depth)
    plt.show()
